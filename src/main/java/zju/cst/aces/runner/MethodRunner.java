...
public class MethodRunner extends ClassRunner {
    ...
    /**
     * Start generating tests for a method
     *
     * @param num the generated test round number
     * @return
     */
    public boolean startRounds(final int num) throws IOException, RuntimeException {
        PromptInfo promptInfo = null;
        // ANNO The temp test name is generated by the following format:
        //  <class name>_<method name>_<method signature (number))>_<test number>_Test
        ...
        for (int rounds = 1; rounds <= Config.maxRounds; rounds++) {
            ...
            totalTokensObserver.update(TokenCounter.countMessageTokens(prompt));
